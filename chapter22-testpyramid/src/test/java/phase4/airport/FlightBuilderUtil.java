...
import phase3.airport.Passenger;
...
//    }
    ...
    public static phase3.airport.Flight buildFlightFromCsv(String flightNumber, int seats, String fileName) throws IOException {
        phase3.airport.Flight flight = new Flight(flightNumber, seats);
        flight.setOrigin("London");
        flight.setDestination("Bucharest");
        ...
        try(BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
            ...
            do {
                ...
                if (line != null) {
                    String[] passengerString = line.toString().split(";");
                    phase3.airport.Passenger passenger = new Passenger(passengerString[0].trim(), passengerString[1].trim(), passengerString[2].trim());
                    flight.addPassenger(passenger);
                }
            } while (line != null);
