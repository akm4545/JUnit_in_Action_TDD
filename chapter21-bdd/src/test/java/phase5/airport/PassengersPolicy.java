...
import phase4.airport.BusinessFlight;
import phase4.airport.EconomyFlight;
import phase4.airport.Flight;
import phase4.airport.Passenger;
import phase4.airport.PremiumFlight;
...
public class PassengersPolicy {
    ...
    private phase4.airport.Flight economyFlight;
    private phase4.airport.Flight businessFlight;
    private Flight premiumFlight;
    private phase4.airport.Passenger mike;
    private phase4.airport.Passenger john;
    @Given("이코노미 항공편에서")
    ...
    public void when일반승객은() {
        mike = new phase4.airport.Passenger("Mike", false);
    }
